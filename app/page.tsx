  ...
  return (
    <div style={{display: "flex", flexDirection: "column", width: "100%", height: "100vh"}}>
      <div style={{flex: "0 0 80%", position: "relative"}}>
        ...
        <HeightMesh_Shaders pressureLevel={250} pngUrl={`http://localhost:8001/gph/250/${datehour}`} landUrl={`http://localhost:8001/landMask`} uvUrl={`http://localhost:8001/uv/${datehour}`} exaggeration={0.25} />;
      </div>
