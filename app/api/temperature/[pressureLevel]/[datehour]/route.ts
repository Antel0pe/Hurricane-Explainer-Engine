// app/api/temperature/[pressureLevel]/[datehour]/route.ts
import { NextRequest, NextResponse } from "next/server";
import { readFile } from "node:fs/promises";
import path from "node:path";
import { parseDatehour, temperatureDir, boundsHeaders } from "../../../_lib/shared";
...
export async function GET(
  ...
  const imgPath = path.join(temperatureDir(pressureLevel), `temp_${ts}.png`);
